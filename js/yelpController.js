  ...
  self.teams = [{voteNum: 0,
                ...
                name:'Bears',
                 ...
                 {voteNum: 2,
                  ...
                  {voteNum: 7,
                  name:'Cardinals',
                  icon:'http://upload.wikimedia.org/wikipedia/en/thumb/7/72/Arizona_Cardinals_logo.svg/1280px-Arizona_Cardinals_logo.svg.png'},
                  {voteNum: 8,
                  name:'Chargers',
                  icon:'http://upload.wikimedia.org/wikipedia/en/thumb/0/06/San_Diego_Chargers_logo.svg/1280px-San_Diego_Chargers_logo.svg.png'},
                  {voteNum: 9,
                  name:'Cheifs',
                  icon:'http://i44.tinypic.com/mvqiph.jpg'},
                  {voteNum: 10,
                  name:'Colts',
                  icon:'http://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Indianapolis_Colts_logo.svg/2000px-Indianapolis_Colts_logo.svg.png'},
                  {voteNum: 11,
                  name:'Cowboys',
                  ...
                  {voteNum: 13,
                  name:'Eagles',
                  icon:'http://upload.wikimedia.org/wikipedia/en/thumb/7/7f/Philadelphia_Eagles_primary_logo.svg/800px-Philadelphia_Eagles_primary_logo.svg.png'},
                  {voteNum: 14,
                  name:'Falcons',
                  icon:'http://upload.wikimedia.org/wikipedia/en/thumb/c/c5/Atlanta_Falcons_logo.svg/1088px-Atlanta_Falcons_logo.svg.png'},
                  {voteNum: 15,
                  name:'Giants',
                  icon:'http://vignette1.wikia.nocookie.net/madden/images/8/81/New_York_Giants_Logo.png/revision/latest?cb=20120716204150'},
                  {voteNum: 16,
                  name:'Jaguars',
                  icon:'http://upload.wikimedia.org/wikipedia/en/thumb/5/5d/Jacksonville_Jaguars.svg/1274px-Jacksonville_Jaguars.svg.png'},
                  {voteNum: 17,
                  name:'Jets',
                  icon:'http://prod.static.jets.clubs.nfl.com/nfl-assets/img/gbl-ico-team/NYJ/logos/home/large.png'},
                  {voteNum: 18,
                  name:'Lions',
                  icon:'http://upload.wikimedia.org/wikipedia/en/thumb/3/3f/New_Lions_Logo.svg/1280px-New_Lions_Logo.svg.png'},
                  {voteNum: 19,
                  name:'Packers',
                  icon:'http://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Green_Bay_Packers_logo.svg/1024px-Green_Bay_Packers_logo.svg.png'},
                  {voteNum: 20,
                  name:'Panthers',
                  icon:'http://upload.wikimedia.org/wikipedia/en/thumb/7/7a/Carolina_Panthers_logo_2012.svg/1280px-Carolina_Panthers_logo_2012.svg.png'},
                  {voteNum: 21,
                  name:'Patriots',
                  icon:'http://upload.wikimedia.org/wikipedia/en/thumb/b/b9/New_England_Patriots_logo.svg/1024px-New_England_Patriots_logo.svg.png'},
                  {voteNum: 22,
                  name:'Raiders',
                  ...
                  {voteNum: 24,
                  name:'Ravens',
                  icon:'http://upload.wikimedia.org/wikipedia/en/thumb/1/16/Baltimore_Ravens_logo.svg/1280px-Baltimore_Ravens_logo.svg.png'},
                  {voteNum: 25,
                  name:'Redskins',
                  icon:'http://vignette1.wikia.nocookie.net/madden/images/c/c4/Washington_Redskins_Logo.png/revision/latest?cb=20120716235848'},
                  {voteNum: 26,
                  name:'Saints',
                  icon:'http://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/New_Orleans_Saints.svg/633px-New_Orleans_Saints.svg.png'},
                  {voteNum: 27,
                  name:'Seahawks',
                  ...
                  {voteNum: 30,
                  name:'Titans',
                  icon:'http://upload.wikimedia.org/wikipedia/en/thumb/c/c1/Tennessee_Titans_logo.svg/1280px-Tennessee_Titans_logo.svg.png'},
                  {voteNum: 31,
                  name:'Vikings',
