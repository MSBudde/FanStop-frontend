...
function yelpController(MyYelpApi, $http) {
  ...
  self.teams = [{voteNum: 0,
                name:'49ers',
                icon:'https://icons.iconarchive.com/icons/astahrr/nfl/128/49ers-icon.png'},
                {voteNum: 1 ,
                name:'Bears',
                 icon: 'https://www.clarkstreetsports.com/site/images/bearslogo.png',},
                 {voteNum: 2,
                  name:'Bengals',
                  icon:'https://prod.static.bengals.clubs.nfl.com/nfl-assets/img/gbl-ico-team/CIN/logos/home/large.png'},
                  {voteNum: 3 ,
                  name:'Bills',
                  icon:'https://vector.me/files/images/2/8/28193/buffalo_bills.png'},
                  {voteNum: 4,
                  name:'Broncos',
                  icon:'https://images.vectorhq.com/images/previews/e63/denver-broncos-logo-psd-446725.png'},
                  {voteNum: 5,
                  name:'Browns',
                  icon:'https://www.prosportsblogging.com/psb/themes/psb/images/icons/nfl-clevelandbrowns.png'},
                  {voteNum: 6,
                  name:'Bucaneers',
                  icon:'https://prod.static.buccaneers.clubs.nfl.com/nfl-assets/img/gbl-ico-team/TB/logos/home/large.png'},
                  {voteNum: 7,
                  name:'Cardinals',
                  ...
                  {voteNum: 9,
                  name:'Cheifs',
                  icon:'https://i44.tinypic.com/mvqiph.jpg'},
                  {voteNum: 10,
                  name:'Colts',
                  ...
                  {voteNum: 11,
                  name:'Cowboys',
                  icon:'https://media-s3-us-east-1.ceros.com/dallas-cowboys/images/2015/08/31/92a6e92fad165d3e99f00b72fd477082/2000px-dallas-cowboys-svg.png'},
                  {voteNum: 12,
                  name:'Dolphins',
                  icon:'https://vignette2.wikia.nocookie.net/madden/images/1/18/Miami_Dolphins_Logo.png/revision/latest?cb=20120713203308'},
                  {voteNum: 13,
                  name:'Eagles',
                  ...
                  {voteNum: 15,
                  name:'Giants',
                  icon:'https://vignette1.wikia.nocookie.net/madden/images/8/81/New_York_Giants_Logo.png/revision/latest?cb=20120716204150'},
                  {voteNum: 16,
                  name:'Jaguars',
                  icon:'https://upload.wikimedia.org/wikipedia/en/thumb/5/5d/Jacksonville_Jaguars.svg/1274px-Jacksonville_Jaguars.svg.png'},
                  {voteNum: 17,
                  name:'Jets',
                  icon:'https://prod.static.jets.clubs.nfl.com/nfl-assets/img/gbl-ico-team/NYJ/logos/home/large.png'},
                  {voteNum: 18,
                  name:'Lions',
                  ...
                  {voteNum: 22,
                  name:'Raiders',
                  icon:'https://www.thesportsbank.net/core/wp-content/uploads/2014/09/oakland-raiders-logo.png'},
                  {voteNum: 23,
                  name:'Rams',
                  icon:'https://vignette3.wikia.nocookie.net/madden/images/5/51/St._Louis_Rams_Logo.png/revision/latest?cb=20120716234547'},
                  {voteNum: 24,
                  name:'Ravens',
                  icon:'https://upload.wikimedia.org/wikipedia/en/thumb/1/16/Baltimore_Ravens_logo.svg/1280px-Baltimore_Ravens_logo.svg.png'},
                  {voteNum: 25,
                  name:'Redskins',
                  icon:'https://vignette1.wikia.nocookie.net/madden/images/c/c4/Washington_Redskins_Logo.png/revision/latest?cb=20120716235848'},
                  {voteNum: 26,
                  name:'Saints',
                  icon:'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/New_Orleans_Saints.svg/633px-New_Orleans_Saints.svg.png'},
                  {voteNum: 27,
                  name:'Seahawks',
                  icon:'https://www.prosportsblogging.com/psb/themes/psb/images/icons/nfl-seattleseahawks.png'},
                  {voteNum: 28,
                  name:'Steelers',
                  icon:'https://vignette1.wikia.nocookie.net/madden/images/5/5d/Pittsburgh_Steelers_Logo.png/revision/latest?cb=20120716204951'},
                  {voteNum: 29,
                  name:'Texans',
                  icon:'https://s5.tinypic.com/110k9xv.jpg'},
                  {voteNum: 30,
                  name:'Titans',
                  icon:'https://upload.wikimedia.org/wikipedia/en/thumb/c/c1/Tennessee_Titans_logo.svg/1280px-Tennessee_Titans_logo.svg.png'},
                  {voteNum: 31,
                  name:'Vikings',
                  icon:'https://prod.static.vikings.clubs.nfl.com/nfl-assets/img/gbl-ico-team/MIN/logos/home/large.png'}
                ];
  self.teamIcons = ['https://icons.iconarchive.com/icons/astahrr/nfl/128/49ers-icon.png']
